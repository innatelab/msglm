...
struct BinnedValues {
    ...
    double probabilityCompareWith(double y, double bandwidth = cpp11::na<double>(), bool negative = true) const;

    double probabilityLessOrEqual(double y, double bandwidth = cpp11::na<double>(), double offset = 0.0) const {
        return probabilityCompareWith(y, bandwidth, true);
    }
    double probabilityGreaterOrEqual(double y, double bandwidth = cpp11::na<double>(), double offset = 0.0) const {
