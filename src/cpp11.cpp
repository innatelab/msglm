...
// binned_stats.cpp
data_frame ContrastStatistics(doubles   X, integers  var2group_var, integers  var2group_group, integers  var2group_contrast, doubles_matrix<by_row>  contrastXvargroup, doubles  contrast_offsets, int   nsteps, double maxBandwidth, function summaryfun, double mlog10pvalue_threshold, double mlog10pvalue_hard_threshold_factor);
extern "C" SEXP _msglm_ContrastStatistics(SEXP X, SEXP var2group_var, SEXP var2group_group, SEXP var2group_contrast, SEXP contrastXvargroup, SEXP contrast_offsets, SEXP nsteps, SEXP maxBandwidth, SEXP summaryfun, SEXP mlog10pvalue_threshold, SEXP mlog10pvalue_hard_threshold_factor) {
  BEGIN_CPP11
